...
class CourseOutlineTool(Tool):
    ...
    def execute(self, course_name: str) -> str:
        ...
        try:
            ...
            try:
                ...
                return (
                    f"Error retrieving lesson information for '{course_title}'. Please try again."
                )
    ...
    def _format_outline(self, course_title: str, course_link: str | None, lessons: list) -> str:
